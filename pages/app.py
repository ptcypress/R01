...
from standardbots import StandardBotsRobot, models  # <-- no 'api'
...
endpoint = colA.text_input("…or type a method path", value=endpoint,
                           help="Example: movement.brakes.get_brakes_state")

# Optional kwargs as JSON
kwargs_text = colB.text_area("Method kwargs (JSON)", value="{}", height=100,
...
# Gentle auto-refresh without an infinite loop
if auto_refresh:
